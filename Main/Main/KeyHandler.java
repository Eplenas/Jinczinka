...
public class KeyHandler extends JPanel {
    ...
    public KeyHandler(gamePanel jz) {
        ...
        mapKey(KeyEvent.VK_G, "character-screen");
        ...
        public void mapKey(int keyCode, String actionName) {
          ...
          public void handleAction(String actionName) {
            ...
            else if (jz.gameState == (jz.characterState)) {}
                handleCharacterStateActions(actionName);
        }
        ...
        private void handlePlayStateActions(String actionName) {
            switch (actionName) {
                ...
                case "character-screen": 
                    jz.gameState = jz.characterState; 
                    break; 
            }
        }
        ...
        private void handleCharacterStateActions(String actionName) {
            switch (actionName) {
                case "exit":
                    jz.gameState = jz.playState; 
                    break; 
